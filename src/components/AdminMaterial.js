      ...
      {showForm && (
        <div style={s.formCard}>
          ...
          <input
            ...
            placeholder="Ej: Guía de alimentación consciente"
          />
          ...
          <div style={s.checkboxRow}>
            <label style={s.checkboxLabel}>
              <input
                type="checkbox"
                checked={form.para_todas}
                onChange={(e) => setForm({ ...form, para_todas: e.target.checked })}
              />
          ...
          <div style={s.formButtons}>
            ...
            <button
              ...
              style={{ ...s.saveBtn, opacity: guardando || !form.titulo.trim() ? 0.5 : 1 }}
            >
            ...
            <div key={mat.id} style={{ ...s.card, opacity: mat.visible ? 1 : 0.5 }}>
              <div style={s.cardHeader}>
                ...
                <div style={s.cardActions}>
                  <button
                    onClick={() => toggleVisible(mat.id, mat.visible)}
                    style={s.toggleBtn}
                    title={mat.visible ? 'Ocultar' : 'Mostrar'}
                  >
                    {mat.visible ? '👁️' : '🚫'}
                  </button>
...
const s = {
  ...
  cardDesc: {
    margin: '4px 0 0', fontSize: 13, color: '#666', lineHeight: 1.4,
    fontFamily: 'Jost, sans-serif',
  },
  cardMeta: {
    margin: '6px 0 0', fontSize: 12, color: '#7a9e7e',
    fontFamily: 'Jost, sans-serif',
  },
